<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8"> <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-full p-6">
                
                <div class="border-b pb-4 mb-6">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white uppercase">Form Input Transaksi Online</h3>
                ...
                <form class="space-y-6" method="POST" action="{{ route('transaksionline.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">No Faktur</label>
                                <input type="text" name="nofakturonline" value="{{ $nofakturonline ?? 'TRX-ONL-001' }}" readonly
                                    class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Tanggal Transaksi</label>
                                <input type="date" name="tanggal_transaksionline" required value="{{ date('Y-m-d') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Nama Sales</label>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Nama Pemasang</label>
                                <input type="text" name="nama_pemasangonline" required placeholder="Nama Pemasang"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Alamat Pemasang</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Jenis Iklan</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Portal Iklan</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Tanggal Muat</label>
                            <input type="date" name="tanggal_muatiklanonline" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Total Muat (Kali)</label>
                            <input type="number" id="total_muatiklanonline" name="total_muatiklanonline" value="1" min="1" required oninput="hitungSemua()"
                    ...
                    <div class="p-4 bg-blue-50 rounded-lg border border-blue-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Harga Satuan (Manual)</label>
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Diskon (Rp)</label>
                                <input type="text" id="diskon_transaksionline" name="diskon_transaksionline" value="0" required 
                                    onkeyup="formatInput(this)"
                                    class="bg-white border border-blue-500 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                            </div>
                            
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Jumlah Dibayar (DP)</label>
                                <input type="text" id="jumlahbayar_transaksionline" name="jumlahbayar_transaksionline" value="0" required 
                                    onkeyup="formatInput(this)"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                        <div>
                            ...
                            <input type="text" id="insentif_transaksionline" name="insentif_transaksionline" readonly value="0"
                        ...
                        <div>
                            ...
                            <input type="text" id="komisi_transaksionline" name="komisi_transaksionline" readonly value="0"
                                class="bg-gray-100 border border-gray-200 text-gray-700 text-sm rounded block w-full p-2" />
                        </div>
                        <div>
                            <label class="block mb-1 font-medium text-gray-500">PPN (11%)</label>
                            <input type="text" id="ppn_transaksionline" name="ppn_transaksionline" readonly value="0"
                                class="bg-gray-100 border border-gray-200 text-gray-700 text-sm rounded block w-full p-2" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                        <div>
                            <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">TOTAL TAGIHAN</label>
                            <input type="text" id="totaltagihan_transaksionline" name="totaltagihan_transaksionline" readonly value="0"
                                class="bg-gray-800 text-white text-2xl font-bold rounded-lg block w-full p-4 text-right" />
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-bold text-red-600 dark:text-white">SISA PIUTANG</label>
                            <input type="text" id="piutang_transaksionline" name="piutang_transaksionline" readonly value="0"
